globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CKzC9hVr.js","assets/layout-segment-context-9VboCx8P.js"];
...
function getDraftSecret() {
	return "b6a66f72-3735-4e16-a7ae-3307dfec404d";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "135333ed-b861-403f-9721-c20c87845bbb";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "135333ed-b861-403f-9721-c20c87845bbb") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "135333ed-b861-403f-9721-c20c87845bbb",
		rootBoundaryId
	});
}
/**
