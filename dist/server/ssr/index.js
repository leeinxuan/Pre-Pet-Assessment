...
var client_references_default = {
	"6efdf509a785": async () => {
		const m = await import("./assets/page-Cq13hddb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	...
	"d041429ec63f": async () => {
		const m = await import("./assets/error-boundary-FvERXuS3.js");
		return {
			get "ErrorBoundary"() {
	...
	"e562e7309659": async () => {
		const m = await import("./assets/layout-segment-context-CH-nQDft.js");
