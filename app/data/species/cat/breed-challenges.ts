  ...
  "mixed-cat": [
    {
      ...
      title: "你以為領養的是短毛貓……",
      description: "你在認養說明會上看上一隻看起來是短毛的幼貓，打算帶牠回家。朋友問你：「你知道牠長大會變成什麼毛型嗎？」",
      questionText: "關於米克斯貓幼貓的毛型預測，以下哪個說法最正確？",
      topic: "米克斯貓毛型與梳理準備",
      reportSummary: "米克斯貓的成貓毛型無法從幼貓外觀準確預測；毛型會影響日常梳理需求。",
      breedKnowledge: "米克斯貓的**成貓毛型無法從幼貓外觀準確預測**。幼貓時看似短毛，長大後可能發展出**半長毛甚至長毛**。毛型影響日常梳理需求：短毛貓通常每週梳理一次即可，而半長毛或長毛米克斯貓需要**更頻繁的梳理**，換毛期若疏忽還可能出現打結。領養前應做好照護任何毛型的準備。",
      correctChoiceIndex: 1,
      correctText: "幼貓的毛型看不準，長大可能是短毛、半長毛或長毛",
      correctExplanation: "米克斯貓的基因來源多樣，幼貓的成貓毛型無法準確預測。有些幼貓看起來短毛，成年後卻長出明顯的半長毛或長毛，照護需求也隨之改變。",
      distractors: [
    ...
    },
    {
      ...
      title: "雜種優勢……是真的嗎？",
      description: "朋友說：「米克斯貓是雜種，基因比較強，不像純種貓那麼容易生病，所以不需要常去看醫生。」你打算怎麼回應？",
      questionText: "關於米克斯貓與健康照護，以下哪個說法最正確？",
      topic: "米克斯貓健康照護",
      reportSummary: "米克斯貓基因多樣性不代表免疫疾病；定期疫苗、健檢與驅蟲仍不可省略。",
      breedKnowledge: "米克斯貓的基因多樣性確實可能降低某些**品種遺傳性疾病**的風險，但這不等於「不需要就醫」。曾為流浪貓的米克斯貓可能接觸過**貓愛滋（FIV）**、**貓白血病（FeLV）**等病毒，應在領養前或到家後完整**篩檢**。定期疫苗、年度健檢、驅蟲，仍是每隻貓不可省略的基本照護。",
      correctChoiceIndex: 1,
      correctText: "米克斯貓的確較少特定品種遺傳疾病，但仍需定期健檢與疫苗",
      correctExplanation: "米克斯貓的基因多樣性雖可能降低某些品種遺傳疾病的風險，但常見貓咪疾病（如牙周病、病毒感染）與定期疫苗、驅蟲仍是每隻貓不可省略的基本照護。",
      distractors: [
  ...
  "british-shorthair": [
    {
      ...
      title: "英短的貪食本性",
      description: "英國短毛貓食慾旺盛，但天生活動量偏低。你打算怎麼幫牠維持健康體重？",
      questionText: "以下哪個做法最能幫助英短維持健康體重？",
      topic: "飲食與體重管理",
      reportSummary: "英短食慾好、活動量低，容易過重；需定時定量餵食並搭配益智漏食玩具。",
      breedKnowledge: "英國短毛貓常見**活動量低**、**食慾旺盛**的照護挑戰，容易在不知不覺中**體重超標**。採**定時定量餵食**，並用**益智漏食玩具**延長進食時間；避免**自由任食**。",
    ...
    },
    {
      sourceQuestionNumber: 2,
      title: "英短的心臟要定期檢查",
      description: "英國短毛貓有較高的肥厚性心肌病（HCM）風險，早期通常沒有明顯症狀。你會怎麼安排健康追蹤？",
      questionText: "關於英短的心臟健康管理，以下哪個說法正確？",
      topic: "品種相關健康篩檢",
      reportSummary: "英短是HCM高風險品種；早期多無症狀，建議定期例行健康檢查含心臟聽診。",
      breedKnowledge: "**肥厚性心肌病（HCM）**早期可能完全沒有症狀；有時只有在例行健康檢查時，才能透過**心雜音**發現線索。定期安排**心臟聽診**，必要時搭配**超音波篩檢**，有助及早發現。",
