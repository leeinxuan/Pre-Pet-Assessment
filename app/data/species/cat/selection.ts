...
export const catBreeds = [
  { id: "mixed-cat", species: "cat", label: "米克斯貓", icon: "🐈", image: "/assets/cat/selection/mixed-cat.png", size: "medium", shortDescription: "外觀與個性各有不同，無法只靠毛色預測。牠們和所有家貓一樣，需要每天的獵捕式互動遊戲來滿足本能，以及定時定量的餵食管理來避免室內生活帶來的過重風險。" },
