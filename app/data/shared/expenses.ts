...
export const expenseCatalog: Record<string, ExpenseRecord> = {
  ...
  "bird-cage": { id: "bird-cage", name: "鳥籠", amount: 800, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-perch-set": { id: "bird-perch-set", name: "棲木組", amount: 300, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-food-bowl": { id: "bird-food-bowl", name: "食碗／食杯", amount: 120, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-water-bowl": { id: "bird-water-bowl", name: "水碗／水杯", amount: 120, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-chew-toy": { id: "bird-chew-toy", name: "啃咬玩具", amount: 200, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-climbing-toy": { id: "bird-climbing-toy", name: "攀爬玩具", amount: 300, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-feces-tray": { id: "bird-feces-tray", name: "糞尿托盤與墊料", amount: 250, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-thermometer": { id: "bird-thermometer", name: "溫度計", amount: 200, category: "一次性準備費", stage: "飼養前準備", recurring: false },
  "bird-carrier": { id: "bird-carrier", name: "鳥用外出籠", amount: 800, category: "一次性準備費", stage: "出發前準備", recurring: false },
  "bird-cover-cloth": { id: "bird-cover-cloth", name: "遮光布", amount: 200, category: "一次性準備費", stage: "出發前準備", recurring: false },
  "bird-starter-food": { id: "bird-starter-food", name: "物種主食飼料", amount: 150, category: "一次性準備費", stage: "出發前準備", recurring: false },
  "bird-arrival-checkup": { id: "bird-arrival-checkup", name: "到家後首次健康檢查", amount: 1200, category: "到家後必要支出", stage: "寵物到家後", recurring: false },
  "bird-food-monthly": { id: "bird-food-monthly", name: "每月飼料費（主食＋鮮食）", amount: 500, category: "每月基本支出", stage: "日常照護", recurring: true },
  "bird-cleaning-monthly": { id: "bird-cleaning-monthly", name: "每月清潔耗材費", amount: 200, category: "每月基本支出", stage: "日常照護", recurring: true },
  "bird-emergency-vet": { id: "bird-emergency-vet", name: "緊急就醫費用", amount: 4000, category: "臨時／醫療支出", stage: "生活變化", recurring: false, fromEmergency: true },
  "bird-senior-checkup": { id: "bird-senior-checkup", name: "高齡健康檢查", amount: 2000, category: "臨時／醫療支出", stage: "生活變化", recurring: false },
  "bird-senior-room": { id: "bird-senior-room", name: "高齡環境調整用品", amount: 1200, category: "高齡用品", stage: "生活變化", recurring: false },
};
