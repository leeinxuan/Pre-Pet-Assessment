  ...
  return (
    <main className="shared-result-page">
      ...
      <section className="shared-result-costs">
        ...
        <dl><div><dt>累積支出</dt><dd>NT$ {currency.format(result.costs.simulatedTotal)}</dd></div><div className="shared-result-cost-total"><dt>最低應準備金額</dt><dd>NT$ {currency.format(result.costs.suggestedTotal)}</dd></div></dl>
      </section>
