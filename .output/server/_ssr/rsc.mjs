...
function getDraftSecret() {
	return "6632b2e4-bd88-488b-9c96-dcb908549f67";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "25ef52bc-8a76-4908-ba1e-5fa389c47867";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "25ef52bc-8a76-4908-ba1e-5fa389c47867") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "25ef52bc-8a76-4908-ba1e-5fa389c47867",
		rootBoundaryId
	});
}
/**
