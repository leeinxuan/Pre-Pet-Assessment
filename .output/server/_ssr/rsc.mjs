...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-Dn2TPp5a.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "b50c977d-2045-4c26-b769-5125a4faf3ff";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ba8c519d-9ccd-4b22-8010-cda6ae24be8f";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ba8c519d-9ccd-4b22-8010-cda6ae24be8f") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ba8c519d-9ccd-4b22-8010-cda6ae24be8f",
		rootBoundaryId
	});
}
/**
