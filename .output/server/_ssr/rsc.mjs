...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-ZMr4ccpc.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "88e369c0-3a46-4fdc-913d-297a4bef8ba2";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "3c1b555d-43ca-4b23-817f-fb6656bc4731";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "3c1b555d-43ca-4b23-817f-fb6656bc4731") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "3c1b555d-43ca-4b23-817f-fb6656bc4731",
		rootBoundaryId
	});
}
/**
