...
function getDraftSecret() {
	return "096136d0-3930-482f-bb93-8be0a28d9968";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "ffea7b25-1ac1-4317-979f-f732f14eaebc";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "ffea7b25-1ac1-4317-979f-f732f14eaebc") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "ffea7b25-1ac1-4317-979f-f732f14eaebc",
		rootBoundaryId
	});
}
/**
