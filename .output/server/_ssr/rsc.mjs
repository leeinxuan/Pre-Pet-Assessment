...
function getDraftSecret() {
	return "5be68827-dcce-4b7a-8a18-523962187e80";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "e40c9730-2bb2-4113-b2c6-99c4fa6392b6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "e40c9730-2bb2-4113-b2c6-99c4fa6392b6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "e40c9730-2bb2-4113-b2c6-99c4fa6392b6",
		rootBoundaryId
	});
}
/**
