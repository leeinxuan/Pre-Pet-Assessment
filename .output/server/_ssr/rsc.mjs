...
function getDraftSecret() {
	return "f897b276-f675-4c62-90f2-0fcc50693bc4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "792d60c1-3aea-4427-b5d3-9a6b4aec25fe";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "792d60c1-3aea-4427-b5d3-9a6b4aec25fe") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "792d60c1-3aea-4427-b5d3-9a6b4aec25fe",
		rootBoundaryId
	});
}
/**
