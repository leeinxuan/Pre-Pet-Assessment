...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-iaX7iHZu.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "8a9affad-719e-4ba2-8fa7-ad9198a60617";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "f5b01fc9-9f45-4308-8bdb-8085134baa00";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "f5b01fc9-9f45-4308-8bdb-8085134baa00") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "f5b01fc9-9f45-4308-8bdb-8085134baa00",
		rootBoundaryId
	});
}
/**
