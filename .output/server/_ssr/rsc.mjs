...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-mKIbibR8.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "4651b5dd-fab3-4bd9-8e68-82bab4941344";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "78c31f2b-ac17-4459-b4d4-7de675be7745";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "78c31f2b-ac17-4459-b4d4-7de675be7745") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "78c31f2b-ac17-4459-b4d4-7de675be7745",
		rootBoundaryId
	});
}
/**
