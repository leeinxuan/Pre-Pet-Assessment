...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-CuEXxmp0.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "15ff306a-5237-4bde-af19-198d6d7145e0";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bf5feddc-f873-4efb-9193-7657b2c5ea4a";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bf5feddc-f873-4efb-9193-7657b2c5ea4a") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bf5feddc-f873-4efb-9193-7657b2c5ea4a",
		rootBoundaryId
	});
}
/**
