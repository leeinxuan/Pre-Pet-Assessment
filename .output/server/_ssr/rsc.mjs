...
function getDraftSecret() {
	return "add87051-d646-4366-8243-9c51fffe82d6";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "bc48757d-d1d3-4c72-8f8f-3d58296a57ac";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "bc48757d-d1d3-4c72-8f8f-3d58296a57ac") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "bc48757d-d1d3-4c72-8f8f-3d58296a57ac",
		rootBoundaryId
	});
}
/**
