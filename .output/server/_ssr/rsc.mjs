...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-B8gGPtjT.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "fd08546d-a154-4bba-b7ff-4cbeb85cc1de";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "09358f0f-f457-4d50-a931-1820ee61225e";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "09358f0f-f457-4d50-a931-1820ee61225e") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "09358f0f-f457-4d50-a931-1820ee61225e",
		rootBoundaryId
	});
}
/**
