...
function getDraftSecret() {
	return "9f968f70-8d39-409d-b59f-cece69dba2b9";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "221785be-a0e1-482c-af58-fb4c96dca4e8";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "221785be-a0e1-482c-af58-fb4c96dca4e8") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "221785be-a0e1-482c-af58-fb4c96dca4e8",
		rootBoundaryId
	});
}
/**
