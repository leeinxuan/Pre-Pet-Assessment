...
var __vite_rsc_assets_manifest_default = {
	"bootstrapScriptContent": "import(\"/assets/index-Ek9BTFiq.js\")",
	"clientReferenceDeps": {
		"6efdf509a785": {
			"js": [
...
function getDraftSecret() {
	return "51578964-80e2-49b1-9a55-bc35665f53b4";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "5ef6cb09-9204-4b3d-9a05-a7f6ba1340b9";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "5ef6cb09-9204-4b3d-9a05-a7f6ba1340b9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "5ef6cb09-9204-4b3d-9a05-a7f6ba1340b9",
		rootBoundaryId
	});
}
/**
