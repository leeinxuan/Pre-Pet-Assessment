...
function getDraftSecret() {
	return "cee56dc4-dac6-4e4c-bd99-c5a8b68eaae5";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "0b07211c-49f2-476c-8a67-0bf2bb07c8b6";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "0b07211c-49f2-476c-8a67-0bf2bb07c8b6") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "0b07211c-49f2-476c-8a67-0bf2bb07c8b6",
		rootBoundaryId
	});
}
/**
