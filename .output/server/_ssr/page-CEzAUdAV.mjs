...
//#region node_modules/.nitro/vite/services/ssr/assets/page-CEzAUdAV.js
...
var catLifeScenarios = [
	...
	},
	{
		...
		requiredCorrectOptionIds: [
			...
			"cat-night-rest-space"
		],
		wrongOptionIds: ["cat-night-laser", "cat-night-hands"],
		correctSummary: [
			"使用逗貓棒、玩偶或球等可實際捕捉的安全玩具。",
			"安排適量互動遊戲，讓牠追逐、捕捉後慢慢收尾。",
			"遊戲後保留安靜休息空間，讓牠能自在放鬆。"
		],
		learningPoints: ["安全且能**實際捕捉**的玩具，能協助滿足貓咪的互動與獵捕需求。", "不用手腳直接逗弄，也不以雷射光點作為主要遊戲；安排遊戲後讓牠有安靜休息空間。"],
		choices: [
			{
				id: "cat-night-laser",
				text: "用雷射光點讓牠一直追，累了自然會休息",
				result: "incorrect",
				...incorrect,
				explanation: "雷射光點不是可實際捕捉的目標，不建議作為主要遊戲方式。",
				suggestion: "改用逗貓棒、玩偶或球等安全實體玩具，讓牠能追逐、捕捉並收尾。"
			},
			{
				id: "cat-night-safe-toys",
				text: "準備逗貓棒、玩偶或球等安全實體玩具，讓牠可以追逐與捕捉",
				result: "correct",
				...positive,
				explanation: "安全、可掌握的實體玩具能提供合適的互動與獵捕出口。"
			},
			{
				id: "cat-night-hands",
				text: "直接用手腳和牠玩，讓牠習慣輕輕撲咬",
				result: "incorrect",
				...incorrect,
				explanation: "手腳逗弄容易讓貓咪把人的身體當作玩具或獵物。",
				suggestion: "改用玩具保持安全距離，讓牠追逐的是玩具而不是人的手腳。"
			},
			{
				id: "cat-night-play-routine",
				text: "安排適量互動遊戲，讓牠玩過後慢慢收尾",
				result: "correct",
				...positive,
				explanation: "規律且不過量的互動，能幫助牠把精力用在合適的活動上。"
			},
			{
				id: "cat-night-rest-space",
				text: "遊戲後保留安靜休息空間，讓牠可以自己放鬆",
				result: "correct",
				...positive,
				explanation: "有活動也有安靜休息，能讓夜晚的生活節奏更穩定。"
			}
		]
	},
	{
		...
		correctSummary: [
			"在合適位置提供穩固抓板、抓柱或跳台。",
			"引導牠使用替代物，並調整家具保護與動線。",
			"保留安全的抓磨與攀爬環境，讓自然行為有合適出口。"
		],
		learningPoints: ["抓磨是貓咪的正常行為，和伸展、標記與放鬆有關；重點是提供**穩固、位置合適**的安全替代物。", "不應去爪、磨牙或剃鬍鬚。提供抓板、抓柱、跳台與合適引導，才能兼顧家具與貓咪需求。"],
		choices: [
			{
				id: "cat-scratch-punish",
				text: "抓到就大聲責罵，讓牠知道不可以抓",
				result: "incorrect",
				...incorrect,
				explanation: "責罵無法提供替代做法，也可能增加壓力。",
				suggestion: "把抓板、抓柱或跳台放到合適位置，再用引導與環境管理協助牠使用。"
			},
			{
				id: "cat-scratch-board",
				text: "在牠常抓或常經過的位置放穩固抓板、抓柱或跳台",
				result: "correct",
				...positive,
				explanation: "位置合適又穩固的替代物，能讓牠把抓磨需求放在安全選擇上。"
			},
			{
			...
			},
			{
				...
				text: "在牠使用抓板或抓柱時給予引導，並用家具保護降低抓錯機會",
				result: "correct",
				...positive,
				explanation: "替代物加上環境調整，比處罰更容易讓行為逐漸穩定。"
			},
			{
				id: "cat-scratch-climbing",
				text: "提供安全跳台或高處，讓牠有合適的活動與觀察空間",
				result: "correct",
				...positive,
				explanation: "安全的垂直空間能讓貓咪有更多自然活動出口。"
			}
		]
	},
	{
		...
		wrongOptionIds: [
			"cat-outdoor-force-walk",
			"cat-outdoor-unprotected",
			"cat-outdoor-carry"
		],
		correctSummary: ["尊重牠留在安全室內的需求，不強迫外出。", "提供抓板、跳台與安全玩具等室內環境豐富化。"],
		learningPoints: ["多數貓咪不需要每天外出活動；安全的室內環境與互動更符合牠的日常需求。", "外出時也不應強抱、徒手抱著或在未防護狀態下放牠離開室內。"],
		choices: [
			{
				id: "cat-outdoor-force-walk",
				text: "把牠強抱出門，想說多試幾次就會習慣",
				result: "incorrect",
				...incorrect,
				explanation: "強迫外出會增加壓力，也可能讓牠更害怕門口、外出用品或照顧者。",
				suggestion: "先尊重牠留在室內的需求，並用安全的室內環境豐富化提供活動。"
			},
			{
				id: "cat-outdoor-respect-boundary",
				text: "尊重牠留在安全躲藏空間的需求，不強迫牠出門",
				result: "correct",
				...positive,
				explanation: "尊重壓力訊號能降低恐懼累積，讓牠保有安全感。"
			},
			{
				id: "cat-outdoor-unprotected",
				text: "打開門後讓牠自己出去看看，反正附近很安靜",
				result: "incorrect",
				...incorrect,
				explanation: "未防護狀態下讓貓咪外出有走失、受驚或其他安全風險。",
				suggestion: "日常活動可在安全室內完成；真正需要移動時，使用安全外出籠。"
			},
			{
				id: "cat-outdoor-indoor-enrichment",
				text: "在室內提供抓板、跳台與安全玩具，安排合適互動",
				result: "correct",
				...positive,
				explanation: "室內環境豐富化能滿足活動、觀察與互動需求。"
			},
			{
				id: "cat-outdoor-carry",
				text: "徒手抱著牠到外面透氣，累了再抱回來",
				result: "incorrect",
				...incorrect,
				explanation: "徒手抱出門容易讓受驚的貓咪掙脫，也會增加壓力與走失風險。",
				suggestion: "讓牠留在安全室內；需要外出時應使用合適的外出籠。"
			}
		]
	},
	{
		...
		choices: [
			{
				id: "cat-alone-food",
				text: "出門前多放一些食物和水，晚點回家再處理其他事",
				result: "incorrect",
				...incorrect,
				explanation: "食物和水不能取代砂盆確認與環境巡視，也可能讓異常狀況沒有人留意。",
				suggestion: "先安排可信任的協助者，並清楚交接需要確認的事項。"
			},
			{
				id: "family-helper",
				text: "請可信任的人協助，並逐項確認時間、意願、照護事項與緊急聯絡方式",
				result: "correct",
				...positive,
				explanation: "貓咪看起來獨立，仍需要穩定的食物、飲水、乾淨砂盆與安全環境。先確認交接內容，能讓牠在你忙碌時仍維持安心與規律。",
				suggestion: "交接時要說明貓咪個性、互動界線、餵食規則、砂盆與環境巡視重點，以及遇到緊急狀況時如何聯絡。"
			},
			{
				id: "cat-no-check",
				text: "貓咪很獨立，等回家後再一起看就好",
				result: "incorrect",
				...incorrect,
				explanation: "獨立不代表不需要日常照護與安全巡視。食物、飲水、貓砂盆與環境仍需要有人確認。",
				suggestion: "安排可信任者協助，並把需要確認的事項交接清楚。"
			},
			{
				id: "cat-late-meal",
				text: "只請人倒飼料，其他事情不用特別交代",
				result: "incorrect",
				...incorrect,
				explanation: "只補食物會漏掉飲水、貓砂盆與環境巡視，也可能讓協助者不知道異常時怎麼聯絡。",
				suggestion: "交接前一起確認食物、飲水、貓砂盆、環境巡視與緊急聯絡方式。"
			}
		]
	},
	{
		...
		choices: [
			{
				id: "cat-health-wait",
				text: "先自己猜原因，再多觀察好幾天看看",
				result: "incorrect",
				...incorrect,
				explanation: "明顯變化不應靠自行判斷原因或拖延很多天。",
				suggestion: "先記錄時間與觀察到的狀況，並聯絡獸醫討論下一步。"
			},
			{
				id: "cat-health-complete-response",
				text: "記錄觀察到的時間與狀況，並聯絡獸醫",
				result: "correct",
				...positive,
				explanation: "先紀錄並聯絡獸醫，能協助專業人員判斷合適的下一步。",
				expenseIds: ["sick-vet-care"]
			},
			{
				id: "cat-health-friend",
				text: "先自己判定只是心情問題，暫時不用聯絡獸醫",
				result: "incorrect",
				...incorrect,
				explanation: "不要自行判定原因；不同變化可能需要由專業人員結合完整資訊判斷。",
				suggestion: "整理食慾、飲水、尿便、活動量與躲藏等變化後聯絡獸醫。"
			},
			{
				id: "cat-health-medicine",
				text: "先自行給藥或用網路方法處理，再決定要不要詢問",
				result: "incorrect",
				...incorrect,
				explanation: "不要自行給藥，這可能讓狀況更難掌握。",
				suggestion: "記下觀察到的改變後聯絡獸醫，依專業人員建議安排後續。"
			}
		]
	},
	{
		...
		choices: [
			{
				...
				text: "提供低入口砂盆、階梯式跳台與溫暖休息處，並安排獸醫追蹤",
				result: "correct",
				...positive,
				explanation: "隨著年齡調整環境與安排追蹤，能讓牠更容易移動、休息與如廁。",
				expenseIds: ["cat-senior-room", "senior-checkup"]
			},
			{
				id: "cat-senior-supplement-only",
				text: "只買保健品，環境先不調整，等明顯不舒服再說",
				result: "incorrect",
				...incorrect,
				explanation: "保健品不能取代生活空間調整與獸醫追蹤。",
				suggestion: "先把日常移動、休息與如廁需要的環境調整好。"
			},
			{
				id: "cat-senior-bed-only",
				text: "只多放一張軟墊，砂盆和跳台都維持原本高度",
				result: "incorrect",
				...incorrect,
				explanation: "休息處重要，但不足以處理進出砂盆與跳躍的生活負擔。",
				suggestion: "同時調整低入口砂盆、階梯式跳台與溫暖休息處。"
			},
			{
				id: "cat-senior-keep-jumping",
				text: "維持原本高跳台和高入口砂盆，讓牠自己慢慢適應",
				result: "incorrect",
				...incorrect,
				explanation: "高跳躍與高入口可能讓移動和如廁變得更吃力。",
				suggestion: "改用低入口砂盆、階梯式跳台與容易到達的溫暖休息處。"
			}
		]
	}
];
	...
	"orange-cat": [
		{
			...
			distractors: [
				{
					text: "每位家人想到就各自投餵，不需要特別登記",
					explanation: "各自投餵時，容易看不見已經提供過的食物與零食。",
					suggestion: "量好份量後，把每次餵食共同記錄在同一個地方。"
				},
				{
					text: "今天有人多餵了，隔天就直接少給一餐補回來",
					explanation: "忽多忽少的補救方式不利於穩定安排，也無法取代清楚的共同記錄。",
					suggestion: "維持原本餵食節奏，從下一次開始依量好的份量共同記錄。"
				},
				{
					text: "只記主食就好，零食不用列進餵食紀錄",
					explanation: "零食也是餵食內容的一部分，省略後會讓紀錄不完整。",
					suggestion: "把主食與零食都寫進早、午、晚的共同紀錄。"
				}
			]
		},
		{
		...
		},
		{
			...
			distractors: [
				{
					text: "只要有人記得就好，不必把內容寫在共同紀錄板",
					explanation: "口頭記憶容易遺漏，其他照顧者也不一定知道今天已餵了什麼。",
					suggestion: "把主食與零食都寫在家人共同使用的紀錄板上。"
				},
				{
					text: "只記錄今天的主食，零食不用算進去",
					explanation: "零食也是餵食內容，沒有記下來會讓資訊不完整。",
					suggestion: "主食、零食與餵食時段都一起記錄。"
				},
				{
					text: "餵完再說，今天忘了記錄也沒關係",
					explanation: "漏掉一次紀錄會讓下一位照顧者難以確認今天的安排。",
					suggestion: "先補上已提供的內容，再一起依紀錄安排下一餐。"
				}
			]
		}
	],
	"tabby-cat": [
		{
			...
			distractors: [
				{
					text: "用手腳逗牠撲咬，互動會更直接",
					explanation: "手腳逗弄可能讓貓咪把人的身體當成玩具。",
					suggestion: "改用安全實體玩具，讓牠追逐的是玩具而不是人的手腳。"
				},
				{
					text: "打開雷射筆讓牠一直追光點",
					explanation: "雷射光點不是可實際捕捉的目標，不建議作為主要遊戲方式。",
					suggestion: "改用可實際捕捉的逗貓棒、玩偶或球。"
				},
				{
					text: "先長時間關在籠裡，等牠不注意線狀物再放出來",
					explanation: "長時間關籠不是處理危險物或活動需求的方法。",
					suggestion: "先收好線狀物，再提供安全玩具、抓板與跳台。"
				}
			]
		},
		{
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			mode === "incorrect" && retryCopy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "此刻需要完成哪些事？（複選）" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "choice-grid",
