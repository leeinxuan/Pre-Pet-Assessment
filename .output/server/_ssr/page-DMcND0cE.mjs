...
//#region node_modules/.nitro/vite/services/ssr/assets/page-DMcND0cE.js
...
var dogBreeds = [
	{
		...
		label: "吉娃娃",
		icon: "🐕",
		image: "/assets/dog/selection/chihuahua.png",
		size: "small",
	...
	},
	{
		...
		label: "貴賓犬",
		icon: "🐩",
		image: "/assets/dog/selection/poodle.png",
		size: "small",
	...
	},
	{
		...
		label: "柴犬",
		icon: "🐕",
		image: "/assets/dog/selection/shiba.png",
		size: "medium",
	...
	},
	{
		...
		label: "邊境牧羊犬",
		icon: "🐕‍🦺",
		image: "/assets/dog/selection/border-collie.png",
		size: "medium",
	...
	},
	{
		...
		label: "拉布拉多",
		icon: "🦮",
		image: "/assets/dog/selection/labrador.png",
		size: "large",
	...
	},
	{
		...
		label: "杜賓犬",
		icon: "🐕",
		image: "/assets/dog/selection/doberman.png",
		size: "large",
	...
	},
	{
		...
		label: "英國古代牧羊犬",
		icon: "🐕",
		image: "/assets/dog/selection/old-english-sheepdog.png",
		size: "large",
	...
	},
	{
		...
		label: "米克斯",
		icon: "🐕",
		image: "/assets/dog/selection/mixed-breed.png",
		size: "medium",
		shortDescription: "個性與體型差異較大，適合先了解牠的實際年齡、體態與生活習慣。準備時可保留彈性，依牠到家後的反應慢慢調整。"
	}
];
var dogSelection = { breeds: dogBreeds };
...
function buildBreedChallengeScenarios(questions, breedId) {
...
function getCatBreedChallengeScenarios(breedId) {
	return buildBreedChallengeScenarios(catBreedChallengeContent[breedId] ?? catBreedChallengeContent["orange-cat"], catBreedChallengeContent[breedId] ? breedId : "orange-cat");
}
var catLifeScenarios = [
		...
		choices: [
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "強迫離開外出籠可能讓貓更緊張，也可能引發防衛或躲藏。",
				suggestion: "先準備新家中的安靜空間，讓牠自己決定何時探索。"
			},
			{
				id: "cat-safe-room",
				...
				result: "correct",
				...positive$1,
				explanation: "保留退路並降低刺激，能幫助貓建立安全感。"
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "多人靠近、聲音與注視會提高剛到家的壓力。",
				suggestion: "先限制人數與聲音，等牠穩定後再慢慢增加互動。"
			},
			{
				id: "cat-sit-nearby",
				text: "一進門就打開全屋，讓牠一次探索所有房間",
				result: "incorrect",
				...incorrect$1,
				explanation: "一次面對整個陌生環境可能增加壓力，也讓牠難以找到可退回的地方。",
				suggestion: "先在新家準備好的安靜空間適應，再依牠的狀態逐步開放探索範圍。"
			}
		]
	},
	{
		...
		learningPoints: ["安全且能**實際捕捉**的玩具，能協助滿足貓咪的互動與獵捕需求。", "不用手腳直接逗弄，也不建議只使用雷射筆；請以逗貓棒、玩偶或球等安全實體玩具進行規律互動，並在遊戲結束前讓牠成功抓到一次。"],
		choices: [
			{
				id: "cat-night-laser",
				text: "用雷射筆讓牠一直追光點，累了自然會睡",
				result: "incorrect",
				...incorrect$1,
				explanation: "不應使用雷射筆；它可能造成傷害，也沒有能讓貓實際捕捉的目標。",
				suggestion: "改用安全、可實際捕捉的實體玩具。"
			},
			{
				...
				result: "correct",
				...positive$1,
				explanation: "安全玩具能分散精力，降低無聊造成的撲咬或叫喚。"
			},
			{
				...
				result: "correct",
				...positive$1,
				explanation: "規律互動能滿足獵捕與活動需求，建立夜間節奏。"
			},
			{
				id: "cat-night-hands",
	...
	},
	{
		...
		learningPoints: ["抓磨是貓咪的正常行為，和伸展、標記與放鬆有關；重點是提供**穩固、位置合適**的安全替代物。", "除平時清潔與修剪指甲外，不應去爪、磨牙或剃鬍鬚；這些做法不能取代抓磨環境。"],
		choices: [
			{
				...
				result: "correct",
				...positive$1,
				explanation: "抓板提供自然抓磨出口；位置合適才容易替代家具。"
			},
			{
				id: "cat-scratch-trim-natural",
				text: "為了不再抓家具，替牠去爪、磨牙或剃鬍鬚",
				result: "incorrect",
				...incorrect$1,
				explanation: "去爪、磨牙或剃鬍鬚不是解決抓磨問題的方式，也不應作為日常處理。",
				suggestion: "提供安全替代環境，並用抓板、抓柱與跳台引導牠自然抓磨。"
			},
			{
				...
				result: "correct",
				...positive$1,
				explanation: "替代物搭配環境管理，比只要求牠不要抓更容易穩定。"
			},
			{
				id: "cat-scratch-climbing",
				text: "整理窗簾、衣櫃與高處路線，確認門窗和紗窗穩固",
				result: "correct",
				...positive$1,
				explanation: "抓磨與攀爬可能牽涉安全風險，先整理環境能避免受傷或逃脫。"
			}
		]
	},
	{
		...
		learningPoints: ["多數貓咪不需要每天外出活動；安全的室內環境與互動更符合牠的日常需求。", "平時讓外出籠成為可接受的物品，有助於就醫或移動時的安全。"],
		choices: [
			{
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "強迫外出可能增加恐懼與逃脫風險。",
				suggestion: "先尊重牠留在室內的需求，並提供安全的室內活動。"
			},
			{
				...
				result: "correct",
				...positive$1,
				explanation: "室內豐富化能滿足活動與互動需求。"
			},
			{
				id: "cat-outdoor-carrier",
				text: "把外出籠放在日常可接觸的位置，慢慢練習需要外出時的安全移動",
				result: "correct",
				...positive$1,
				explanation: "平時讓外出籠變成可接受的物品，有助就醫或移動。"
			}
		]
	},
	{
	...
	},
	{
		...
		choices: [
			{
				id: "cat-health-wait",
				text: "先自行上網查詢症狀，照網友分享的方法在家觀察幾天",
				result: "incorrect",
				...incorrect$1,
				explanation: "網路資訊和他人的經驗不能取代獸醫判斷；明顯變化不應延後聯繫獸醫。",
				suggestion: "可以整理可信資料供溝通，但先記錄時間與觀察到的狀況，並聯絡獸醫討論下一步。"
			},
			{
				id: "cat-health-complete-response",
				text: "記下食慾、飲水、尿便、活動與躲藏的前後變化，準備外出籠與可用資料，並立即聯繫獸醫",
				result: "correct",
				...positive$1,
				explanation: "多項變化一起出現時，完整紀錄、就醫準備與聯繫獸醫要一起做；紀錄不能延後急症處置。",
				expenseIds: ["sick-vet-care"]
			},
			{
				id: "cat-health-friend",
				text: "拍一張照片傳給有養貓的朋友，等對方回覆後再決定",
				result: "incorrect",
				...incorrect$1,
				explanation: "朋友經驗無法取代獸醫判斷；影像可保留，但仍應主動聯繫獸醫。",
				suggestion: "整理觀察資料後儘速聯絡獸醫。"
			},
			{
				id: "cat-health-medicine",
				text: "先用家裡的人用藥或剩下的藥物試試看",
				result: "incorrect",
				...incorrect$1,
				explanation: "未經獸醫指示的藥物可能對貓有害，也會干擾後續判斷。",
				suggestion: "不要自行給藥，先記錄狀況並聯絡獸醫。"
			}
		]
	},
	{
		...
		choices: [
			{
				id: "cat-senior-complete-plan",
				text: "增設高度適中的砂盆與地墊、改成階梯式設施並準備保暖休息處；每半年健檢、每週量體重並記錄日常變化",
				result: "correct",
				...positive$1,
				explanation: "如廁、活動、休息與健康追蹤一起調整，才能更完整回應高齡生活需求。",
				expenseIds: ["cat-senior-room", "senior-checkup"]
			},
			{
				id: "cat-senior-supplement-only",
				text: "先換成高齡保健配方與關節保健品，平時留意食慾；下次例行就醫時再一起詢問",
				result: "incorrect",
				...incorrect$1,
				explanation: "飲食或保健品可能是日常照護的一部分，但不能取代眼前的生活空間調整與獸醫追蹤。",
				suggestion: "先把日常移動、休息與如廁需要的環境調整好。"
			},
			{
				id: "cat-senior-bed-only",
				text: "先在牠常待的角落增加軟墊與保暖處，等牠更不願跳或上砂盆時再調整其他動線",
				result: "incorrect",
				...incorrect$1,
				explanation: "休息處很重要，但等到生活困難更明顯才調整，可能錯過減少如廁與活動負擔的時機。",
				suggestion: "同時調整低入口砂盆、階梯式跳台與溫暖休息處。"
			},
			{
				id: "cat-senior-keep-jumping",
				text: "維持原本高跳台，讓牠多跳一點就會慢慢適應",
				result: "incorrect",
				...incorrect$1,
				explanation: "忽略行動變化可能增加關節負擔，也可能讓牠減少使用生活空間。",
				suggestion: "改用高度合適的砂盆與階梯式設施，降低移動負擔。"
			}
		]
	}
];
...
var walkingPrepItems = [
	{
		id: "leash",
		label: "牽繩／胸背帶",
		image: "/assets/dog/preparation/leash.png"
	},
	{
		id: "bag",
		label: "撿便袋",
		image: "/assets/dog/daily/poop-bag-1.png"
	},
	{
		id: "water",
		label: "水",
		image: "/assets/dog/life/waterbottle.png"
	}
];
var walkingScenes = [
	{
		title: "家門口往人行道",
		image: "/assets/dog/daily/door-to-sidewalk.jpg",
		mobileImage: "/assets/dog/daily/door-to-sidewalk-mobile.jpg",
		poopEvent: false
	},
	{
		title: "公園",
		image: "/assets/dog/daily/park.png",
		mobileImage: "/assets/dog/daily/park-mobile.jpg",
		poopEvent: false
	},
	{
		title: "公園 2",
		image: "/assets/dog/daily/park-poop-event.png",
		mobileImage: "/assets/dog/daily/park-poop-event-mobile.jpg",
		poopEvent: true
	},
	{
		title: "人行道往家門口",
		image: "/assets/dog/daily/sidewalk-to-home.jpg",
		mobileImage: "/assets/dog/daily/sidewalk-to-home-mobile.jpg",
		poopEvent: false
	}
];
var walkingSceneLayout = {
	0: {
		startX: 30,
		startY: 50,
		endX: 65,
...
function getDogBreedChallengeScenarios(breedId) {
	return buildBreedChallengeScenarios(dogBreedChallengeContent[breedId] ?? dogBreedChallengeContent.shiba, dogBreedChallengeContent[breedId] ? breedId : "shiba");
}
var dogLifeScenarios = [
	{
		...
		choices: [
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "這個做法可能讓牠更緊張。被強行抱起會讓小狗失去退路，增加防衛反應，也可能降低牠對新環境的安全感。先放低互動強度，讓牠用自己的速度探索。"
			},
			{
				id: "quiet-explore",
				text: "保持距離，給牠安靜適應的時間",
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "持續靠近與呼喚會增加刺激，讓還在適應中的小狗難以安心觀察，可能變得更緊張或躲避。先退開一些，讓牠保有安靜且能退回的安全空間。"
			},
			{
				id: "quiet-nearby",
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "想陪伴牠的心意很好，但頻繁伸手仍可能讓剛到家的小狗感到壓力，難以真正休息。可以安靜待在附近，先不主動碰觸，等牠願意靠近時再互動。"
			}
		]
	},
	{
		...
		learningPoints: ["吠叫是狗狗的溝通方式。先觀察**何時、對什麼叫**，再判斷是警戒、害怕、無聊或不舒服。", "責罵只可能暫時停止聲音，卻未處理原因；若持續發生，可記錄**頻率、時間與觸發情境**後詢問專業人員。"],
		choices: [
			{
				id: "bark-play",
				text: "提供遊戲與互動，增加安全感",
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "單純責罵可能增加緊張，也無法處理吠叫背後的原因。應先觀察聲音、壓力、活動量或身體不適等可能的觸發因素。"
			},
			{
				id: "bark-expert",
	...
	},
	{
		...
		learningPoints: ["啃咬是**狗狗的自然行為**，幼犬換牙、探索、無聊或壓力都可能讓啃咬增加。", "選擇符合體型且不易碎的玩具，並在**咬對物品時立即鼓勵**；玩具破損時要更換，避免誤食。"],
		choices: [
			{
				id: "chew-toys",
				text: "提供多樣化且安全的啃咬玩具",
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "打罵或驚嚇可能造成壓力、破壞信任，也不一定能解決探索與情緒需求。先收好危險物品，並把牠引導到安全的啃咬玩具。"
			},
			{
	...
	},
	{
		...
		learningPoints: ["睡醒、進食與玩耍後常是如廁時機；在正確地點完成後要**立即獎勵**。", "事後責罵無法教會正確地點；若突然頻尿或憋不住，應先請獸醫**排除健康問題**。"],
		choices: [
			{
				id: "toilet-material",
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "責罵可能讓狗狗害怕，卻不一定知道正確如廁地點。應增加合適的如廁機會，並在牠於正確地點完成時立即給予獎勵。"
			}
		]
	},
	{
		...
		choices: [
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "早上多放食物和水仍不能取代一整天的排泄、活動與狀況觀察，也可能造成過量進食或突發狀況沒有人發現。確定要加班時，應先安排能接手照顧的人，並清楚交接需求。"
			},
			{
				id: "family-helper",
				text: "請同住家人或朋友協助",
				result: "correct",
				...positive$1,
				explanation: "你不只是想到一個人，也認真確認對方的時間、意願、照護知識與緊急聯絡方式。這樣的交接才能讓小狗在你忙碌時仍獲得穩定照顧。"
			},
			{
				id: "guard-dog-can-wait",
				text: "狗狗本來就有顧家的功能，在家裡睡久一點沒關係",
				result: "incorrect",
				...incorrect$1,
				explanation: "會顧家，不等於能長時間獨處。超過八小時無人照護，狗狗可能錯過排泄、飲水與活動，也可能因焦慮或無聊而吠叫、破壞物品。確定會晚歸時，仍要安排合適的人中途協助照顧。"
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "把晚餐、排泄與活動一路延後到回家，會讓小狗長時間等待，也無法因應加班比預期更晚或臨時狀況。確定會晚歸時，應先安排可信任的人按平常時間協助基本照顧。"
			}
		]
	},
	{
		...
		choices: [
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "朋友的經驗可以提供陪伴，但相似外觀不一定代表相同原因，仍可能錯過需要檢查的狀況。可以整理朋友提醒的觀察重點，但醫療判斷與用藥仍應交給獸醫。"
			}
		]
	},
	{
		...
		choices: [
			...
			},
			{
				...
				result: "incorrect",
				...incorrect$1,
				explanation: "高齡照顧需要提前準備。等到症狀很嚴重才處理，可能延誤照顧，也會讓小狗承受更多不適；醫療基金、健康觀察與日常照護都應在問題變嚴重前開始規劃。"
			},
			{
...
function getBreedChallengeScenarios(breedId) {
	return breedId === "orange-cat" || breedId === "tabby-cat" ? getCatBreedChallengeScenarios(breedId) : getDogBreedChallengeScenarios(breedId);
}
...
var catSelection = { breeds: catBreeds };
/** 共用金額格式與費用計算資料。 */
var money = new Intl.NumberFormat("zh-TW");
var breeds$1 = [...dogBreeds, ...catBreeds];
var sizeBasedCosts = {
	small: {
		monthlyFood: 800,
...
function getPetSizeForBreed(breedId) {
	const size = breeds$1.find((item) => item.id === breedId)?.size;
...
var dogRoomItems = [
	{
		...
		label: "睡墊",
		icon: "🛏️",
		image: "/assets/dog/room/pet-bed.png",
		placement: {
			x: 67,
			y: 83,
			width: 32,
	...
	},
	{
		...
		label: "水碗",
		icon: "💧",
		image: "/assets/dog/room/water-bowl.png",
		placement: {
			x: 32,
			y: 90,
			width: 12,
	...
	},
	{
		...
		label: "狗碗",
		icon: "🥣",
		image: "/assets/dog/room/food-bowl.png",
		placement: {
			x: 41,
			y: 90,
			width: 10,
	...
	},
	{
		...
		label: "尿墊",
		icon: "▧",
		image: "/assets/dog/room/pee-pad.png",
		placement: {
			x: 15,
			y: 85,
			width: 20,
	...
	},
	{
		...
		label: "寵物專用清潔用品",
		icon: "🧼",
		image: "/assets/dog/room/cleaner.png",
		placement: {
			x: 39,
			y: 46,
			width: 10,
	...
	},
	{
		...
		label: "飼料",
		icon: "🦴",
		image: "/assets/dog/room/food.png",
		placement: {
			x: 50,
			y: 85,
			width: 9,
...
var dogHazards = [
	{
		...
		label: "小物品",
		icon: "●",
		image: "/assets/dog/room/small-items.png",
		placement: {
			x: 40,
			y: 75,
			width: 12,
	...
	},
	{
		...
		label: "巧克力",
		icon: "🍫",
		image: "/assets/dog/room/chocolate.png",
		placement: {
			x: 89,
			y: 78,
			width: 10,
	...
	},
	{
		...
		label: "一般清潔劑",
		icon: "🧴",
		image: "/assets/dog/room/detergent.png",
		placement: {
			x: 62,
			y: 64,
			width: 10,
	...
	},
	{
		...
		label: "電線",
		icon: "🔌",
		image: "/assets/dog/room/wire.png",
		placement: {
			x: 12,
			y: 78,
			width: 20,
...
var dogTrunkItems = [
	{
		...
		label: "身分證",
		kind: "document",
		image: "/assets/dog/preparation/id-card.png",
		preparedLabel: "已攜帶",
	...
	},
	{
		...
		label: "飼養文件",
		kind: "document",
		image: "/assets/dog/preparation/adoption-documents.png",
		preparedLabel: "已攜帶",
	...
	},
	{
		...
		label: "運輸籠＋尿墊",
		kind: "supply",
		image: "/assets/dog/preparation/carrier.png",
		preparedLabel: "已準備",
	...
	},
	{
		...
		label: "水碗",
		kind: "supply",
		image: "/assets/dog/preparation/water-bottle.png",
		preparedLabel: "已準備",
...
var dogDepartureTrunkItems = [
	...
	},
	{
		...
		label: "尿墊",
		kind: "supply",
		image: "/assets/dog/preparation/pee-pad.png",
		preparedLabel: "已準備",
...
var dogLayout = {
	roomDoorplatePlacement,
	arrivalMealMobilePlacements
};
/** 犬隻照護指南與網頁回顧共用資料。 */
var dogReport = {
	checklistGroups: [
...
var catLayout = {
	roomPlacements: catRoomPlacements,
	hazardPlacements: catHazardPlacements
};
var catRoomItems = [
	{
		id: "cat-safe-window",
		...
		...catRoomPlacements["cat-safe-window"],
		required: true,
		need: "安全",
	...
	},
	{
		...
		...catRoomPlacements["cat-hide-box"],
		required: true,
		need: "安全",
	...
	},
	{
		...
		...catRoomPlacements["cat-rest-space"],
		required: true,
		need: "休息",
	...
	},
	{
		...
		...catRoomPlacements["cat-litter-box"],
		required: true,
		need: "排泄",
	...
	},
	{
		...
		...catRoomPlacements["cat-food-bowl"],
		required: true,
		need: "飲食",
		expenseId: "food-bowl",
	...
	},
	{
		...
		...catRoomPlacements["cat-water-bowl"],
		required: true,
		need: "飲食",
		expenseId: "water-bowl",
	...
	},
	{
		...
		...catRoomPlacements["cat-scratcher"],
		required: true,
		need: "活動",
	...
	},
	{
		...
		icon: "✦",
		image: catAssets.room.scratchingBoard,
		...catRoomPlacements["cat-safe-toy"],
		required: true,
		need: "活動",
...
var catHazards = [
	{
		...
		...catHazardPlacements["cat-toxic-plants"],
	...
	},
	{
		...
		...catHazardPlacements["cat-human-medicine"],
	...
	},
	{
		...
		...catHazardPlacements["cat-string"],
	...
	},
	{
		...
		...catHazardPlacements["cat-essential-oil"],
	...
	},
	{
		...
		...catHazardPlacements["cat-cleaner"],
	...
	},
	{
		...
		...catHazardPlacements["cat-cooling-product"],
...
*/
var catTrunkItems$1 = dogDepartureTrunkItems.filter((item) => item.id !== "leash").map((item) => {
...
var catPreparation = { trunkItems: catTrunkItems$1 };
/** 貓咪照護指南與網頁回顧共用資料。 */
var catReport = {
	checklistGroups: [
		{
...
({ ...positive }), { ...partial }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...partial }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...partial }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...positive }, { ...partial }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...partial }, { ...incorrect }, { ...positive }, { ...partial }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...partial }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect }, { ...positive }, { ...positive }, { ...incorrect };
/** @deprecated 相容舊引用；實際品種資料位於 data/species/{dog,cat}/selection.ts。 */
var breeds = [...dogBreeds, ...catBreeds];
...
var dogLifeAsset = (fileName) => `${dogAssets.life.root}/${fileName}`;
var dogDailyAsset = (fileName) => `${dogAssets.daily.root}/${fileName}`;
var arrivalVideoSource = dogLifeAsset("arrival-transition.mp4");
var correctAnswerVideos = [dogLifeAsset("correct-answer.mp4"), dogLifeAsset("correct-answer2.mp4")];
...
function withPetName(text, petName) {
	...
	const withPlaceholders = text.replaceAll("`{petName}`", displayName).replaceAll("{petName}", displayName);
	if (!petName.trim()) return withPlaceholders;
	return withPlaceholders.replaceAll("豆豆", displayName).replaceAll("小狗", displayName).replaceAll("狗狗", displayName);
}
var lifeStageLabels = {
	arrival: "適應新家與安全感",
	daily: "日常照護",
...
function otherCorrectChoices(scenario, choice, petName) {
	...
	if (scenario.id === "busy-daily-care") return [];
...
function DelayedContinueButton({ label = "繼續", onContinue, disabled = false, hint, immediate = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		}), visible && disabled && hint && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("small", {
			className: "delayed-continue-hint",
			children: hint
		})]
	});
}
function renderKnowledgeText(text) {
	return text.split(/(\*\*.*?\*\*)/g).filter(Boolean).map((part, index) => part.startsWith("**") && part.endsWith("**") ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
		className: "knowledge-emphasis",
		children: part.slice(2, -2)
	}, `${part}-${index}`) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: part }, `${part}-${index}`));
}
function IncorrectExplanation({ text }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
		className: "incorrect-feedback-explanation",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
			className: "incorrect-feedback-key",
			children: keyPoint
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				breedHighlight,
				correctItems && correctItems.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "feedback-knowledge-card",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", {
						...
						children: correctItems.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: renderKnowledgeText(item) }, item))
					})]
				}),
...
function BreedKnowledgeHighlight({ text, label = "品種小知識" }) {
	const lines = text.split(/\n+/);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "walking-reflection-note breed-care-reflection",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "breed-knowledge-heading",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				"aria-hidden": "true",
				children: "💡"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: label })]
		}), lines.map((line, index) => line.trim() && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: renderKnowledgeText(line.trim()) }, `${line}-${index}`))]
	});
}
...
function TimePassTransition({ onComplete }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("video", {
			ref: videoRef,
			src: dogLifeAsset("time-passes-aging.mp4"),
			autoPlay: true,
			playsInline: true,
			preload: "metadata",
			"aria-label": "時間流逝過場動畫",
...
function ScenarioFeedback({ scenario, choice, petName, onRetry, onContinue, onReplay, continueImmediately = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IncorrectExplanation, { text: withPetName(choice.explanation, petName) }),
...
function ScenarioCard({ scenario, petName, answer, backupNames, feedbackOpen, onChoose, onRetry, onContinue, onReplay, continueImmediately = false }) {
	...
	const scenarioVideo = scenario.id === "arrival-adjustment" ? {
		src: dogLifeAsset("first-day.mp4"),
		label: "小狗第一天適應新家的影片"
	} : scenario.id === "illness-vet" ? {
		src: dogLifeAsset("sick.mp4"),
		label: "小狗生病與就醫情境影片"
	} : null;
...
function SeniorMedicalKnowledge() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "senior-medical-knowledge",
		"aria-labelledby": "senior-medical-knowledge-title",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "senior-medical-knowledge-heading",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				"aria-hidden": "true",
				children: "💡"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
				id: "senior-medical-knowledge-title",
				children: "高齡後的長期醫療"
			})]
...
function VideoScenarioActivity({ scenario, answer, petName, breed, onChoose, onCorrectComplete, resetSignal, onReplay, continueImmediately = false }) {
	...
	const source = scenario.id.startsWith("cat-") ? void 0 : scenario.id === "arrival-adjustment" ? dogLifeAsset("first-day.mp4") : scenario.id === "growing-old" ? dogLifeAsset("senior-life.mp4") : dogLifeAsset("sick.mp4");
	...
	if (mode === "positive" && selectedChoice) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CorrectFeedbackLayout, {
			...
			breedHighlight: breedKnowledge ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BreedKnowledgeHighlight, {
				text: withPetName(breedKnowledge, petName),
				label: `${breedLabelForId(breed)}小知識`
			}) : null,
			...
			otherTips: isSeniorScenario ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SeniorMedicalKnowledge, {}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OtherCorrectTips, {
				scenario,
				choice: selectedChoice,
				petName
			}),
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IncorrectExplanation, { text: withPetName(withBreedName(selectedChoice.explanation, breed), petName) }),
...
function DailyBehaviorActivityMulti({ answers, petName, onChooseMultiple, onContinue, resetSignal, onReplay, continueImmediately = false, scenarioIds = dailyBehaviorScenarioIds, species = "dog" }) {
	...
	const behaviorVideoSource = species === "cat" ? dailyBehaviorVideos[scenario?.id ?? ""] : scenario ? dailyBehaviorVideos[scenario.id] ?? dogLifeAsset("chewing-on-things.mp4") : dogLifeAsset("chewing-on-things.mp4");
	...
	if (mode === "positive") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CorrectFeedbackLayout, {
		...
		correctItems: learningPoints.map((item) => species === "cat" ? item.replaceAll("{petName}", petName || "貓咪") : withPetName(item, petName)),
		...
		children: [
			...
			mode === "incorrect" && retryCopy ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IncorrectExplanation, { text: withPetName(retryCopy.explanation, petName) }),
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "daily-behavior-question-row",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "此刻需要完成哪些事？（複選）" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
...
function BusyCareActivity({ scenario, answer, petName, members, species = "dog", onMembersChange, onChoose, onContinue, resetSignal, onReplay, continueImmediately = false }) {
	...
	const [helperChecks, setHelperChecks] = (0, import_react.useState)({});
	const [sceneVideoFailed, setSceneVideoFailed] = (0, import_react.useState)(false);
	const [videoFailed, setVideoFailed] = (0, import_react.useState)(false);
	const [, setVideoFinished] = (0, import_react.useState)(false);
	...
	const helperQuestions = [
		...isCat ? [{
			id: "available",
			text: `${helperName || "對方"}是否確定有時間，可以在約定時段完成照護？`,
			short: "尚未確認是否有時間協助"
		}] : [],
		{
			id: "knows-needs",
	...
	function confirmHelperCandidate() {
		...
		if (trimmedName && !members.some((member) => member.name.trim().toLocaleLowerCase() === trimmedName.toLocaleLowerCase())) onMembersChange([...members, {
			id: `busy-helper-${Date.now()}`,
			name: trimmedName,
			age: null,
			isPlayer: false
		}]);
	...
	if (mode === "positive" && selectedChoice) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CorrectFeedbackLayout, {
		...
		otherTips: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: isCat ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				"aria-hidden": "true",
				children: "💡"
			}), "貓咪小知識"] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [displayPetName, "看起來獨立，仍需要穩定的食物、飲水、乾淨砂盆與安全環境。忙碌時先安排可信任的人協助，能讓牠的日常維持安心與規律。"] })] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "busy-care-slogan",
					children: "在狗狗的世界裡，你就是他的全部。"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					"aria-hidden": "true",
					children: "💡"
				}), "留給自己的一個問題"] }),
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: !isCat && !sceneVideoFailed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoWithToggle, {
					...
					src: dogLifeAsset("busy-daily-care.mp4"),
					loop: true,
					ariaLabel: "疲憊忙碌的日子情境影片",
					onError: () => setSceneVideoFailed(true)
					...
					src: isCat ? catAssets.life.safeRoom : dogAssets.feeding.room,
					alt: "居家房間場景"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					className: "busy-care-hungry-dog",
					src: isCat ? catAssets.life.orangeCat : dogLifeAsset("shiba-hungry.png"),
					alt: `${displayPetName}在房間裡等待照顧`
				})] })
			}), mode === "family" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				className: "busy-care-members",
				"aria-live": "polite",
				children: familyStep === "name" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "協助者 1 / 2" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "你會找誰幫忙？" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "可以是同住家人，也可以是你信任的朋友。先寫下一個實際可聯絡的人。" })
					] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						className: "busy-helper-name-field",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "協助者姓名或稱呼" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "text",
							value: helperName,
							placeholder: "例如：姊姊、阿德",
							maxLength: 20,
							onChange: (event) => setHelperName(event.target.value),
							onKeyDown: (event) => {
								if (event.key === "Enter" && helperName.trim()) setFamilyStep("check");
							}
						})]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							onClick: () => setFamilyStep("check"),
							children: ["下一步，確認是否合適 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" })]
						})]
					})
				] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "協助者 2 / 2" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { children: [
						"一起確認",
						helperName.trim(),
						"是否合適"
					] })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "busy-helper-checklist",
						children: helperQuestions.map((question, questionIndex) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "busy-helper-question",
							role: "group",
							"aria-label": question.text,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: questionIndex + 1 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "busy-helper-question-text",
								children: question.text
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: helperChecks[question.id] === "yes" ? "is-selected" : "",
								"aria-pressed": helperChecks[question.id] === "yes",
								onClick: () => setHelperChecks((current) => ({
									...current,
									[question.id]: "yes"
								})),
								children: "是"
								...
								type: "button",
								className: helperChecks[question.id] === "no" ? "is-selected is-no" : "",
								"aria-pressed": helperChecks[question.id] === "no",
								onClick: () => setHelperChecks((current) => ({
									...current,
									[question.id]: "no"
								})),
					...
					shouldShowHelperUncertainty && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "busy-care-family-feedback",
						role: "status",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: "這位協助者還有幾件事需要先確認" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: unsuitableHelperReasons.map((reason) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: reason }, reason)) }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { children: [
								"你可以先和",
								helperName.trim(),
								"談清楚，或改找另一位更適合的協助者。"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "busy-care-member-actions busy-helper-check-actions",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "secondary",
							onClick: resetHelperCandidate,
							children: "選擇其他人"
						}), !shouldShowHelperUncertainty && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							className: "primary",
							disabled: !allHelperChecksAnswered,
							onClick: confirmHelperCandidate,
							children: ["確認這位協助者 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "→" })]
						})]
					})
				] })
			}) : mode === "incorrect" && selectedChoice ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: "這個做法可能不太適合" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(IncorrectExplanation, { text: withPetName(selectedChoice.explanation, petName) }),
					selectedChoice.suggestion && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "incorrect-suggestion",
...
function BreedChallengeActivity({ breed, petName, answers, onChoose, onContinue, resetSignal, onReplay, continueImmediately = false }) {
	...
	if (mode === "positive" && selectedChoice) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CorrectFeedbackLayout, {
			...
			intro: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: withPetName(selectedChoice.explanation, petName) }),
			breedHighlight: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BreedKnowledgeHighlight, {
				text: withPetName(breedKnowledge, petName),
				label: isCatBreedChallenge ? "貓咪小知識" : `${breedLabel}小知識`
			}),
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: challengeVideoSource && !questionVideoFailed ? "breed-challenge-video-placeholder breed-challenge-video-frame" : "breed-challenge-video-placeholder",
				children: challengeVideoSource && !questionVideoFailed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(VideoWithToggle, {
					className: "breed-challenge-video",
					src: challengeVideoSource,
					loop: true,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: !activity.arrivalMealFoodReady ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								src: isCat ? catAssets.feeding.food : dogAssets.feeding.food,
								alt: isCat ? "貓主食" : "飼料"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: !activity.arrivalMealWaterReady ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								...
								src: isCat ? catAssets.feeding.waterBowl : dogAssets.feeding.waterBottle,
								alt: "水瓶"
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						src: isCat ? catAssets.life.safeRoom : dogAssets.feeding.mobileRoom,
						alt: ""
					}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						src: isCat ? catAssets.life.orangeCat : complete ? dogLifeAsset("shiba-dog.png") : dogLifeAsset("shiba-sad.png"),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						...
						src: isCat ? catAssets.feeding.waterBowl : activity.arrivalMealWaterReady ? dogAssets.feeding.waterBowl : dogAssets.feeding.emptyWaterBowl,
						alt: activity.arrivalMealWaterReady ? "裝好水的水碗" : "空水碗"
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						className: "arrival-meal-food",
						style: arrivalMealPlacementStyle("food"),
						src: isCat ? catAssets.feeding.foodBowl : activity.arrivalMealFoodReady ? dogAssets.feeding.foodBowl : dogAssets.feeding.emptyFoodBowl,
			...
			!selectedTime ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: `cat-rescue-litter-box${litterFilled ? " is-filled" : ""}`,
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: catLitterRescueAssets.litterBox,
								alt: "貓砂盆"
							})
						}),
						catLitterRescueConfig.wasteItems.map((item) => !hasCatInspectionToken(selected, `discarded-${roundKey}`, item.id) && carryingWaste !== item.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							...
							"aria-label": `鏟起${item.label}`,
							onClick: () => pickWaste(item.id)
						}, item.id) : null),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
					...
					children: [!wasteCleared ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								"aria-label": "拖曳貓砂鏟",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									src: catLitterRescueAssets.scoop,
									alt: ""
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									"aria-hidden": "true",
									children: "▱"
...
function interpolateWalkingPoint(start, waypoint, end, progress, turnAt = .55) {
	const safeProgress = Math.max(0, Math.min(1, progress));
	const safeTurnAt = Math.max(.05, Math.min(.95, turnAt));
	const hasWaypoint = Boolean(waypoint);
	const segmentProgress = hasWaypoint ? safeProgress <= safeTurnAt ? safeProgress / safeTurnAt : (safeProgress - safeTurnAt) / (1 - safeTurnAt) : safeProgress;
	...
	return {
		...
		scale: Math.max(.05, lerp(from.scale, to.scale, segmentProgress))
	};
}
function getWalkingCharacterStyle(sceneIndex, position, mobile = false) {
	...
	const start = mobile ? {
		x: layout.mobileStartX,
		y: layout.mobileStartY,
		scale: layout.mobileScale
	} : {
		x: layout.startX,
		y: layout.startY,
		scale: layout.scale
	...
	const end = mobile ? {
		x: layout.mobileEndX ?? layout.endX,
		y: layout.mobileEndY ?? layout.endY,
		scale: layout.mobileEndScale ?? layout.endScale ?? layout.scale
	} : {
		x: layout.endX,
		y: layout.endY,
		scale: layout.endScale ?? layout.scale
	};
	const point = interpolateWalkingPoint(start, mobile ? layout.mobileWaypoint : layout.waypoint, end, progress, layout.turnAt);
	return {
		"--walk-left": `${point.x}%`,
		"--walk-top": `${point.y}%`,
...
function WalkingActivity({ activity, petName, onChange, onAddExpense, onContinue, resetSignal }) {
	...
	const renderWalkingEventCard = (className = "") => walkingEventMessage ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: `walking-event-card ${className}`,
		role: "status",
		children: [
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: dogDailyAsset("leash-choice.png"),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
						src: dogDailyAsset("off-leash-choice.png"),
...
function LifeJourney({ index, petName, breed, species = "dog", answers, activity, completedIds, expenses, backupNames, members, roomReady, onIndex, onChoose, onChooseMultiple, onMembersChange, onActivityChange, onCompleteItem, onAddExpense, onStageChange, onBack, onComplete }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [isDailyBehaviorActivity ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DailyBehaviorActivityMulti, {
			answers,
			petName,
			onChooseMultiple,
...
function getLifeStageRanges(breed, species = "dog") {
	...
	return [
		...
		{
			label: config.copy.lifeChallengeLabel(breedLabel),
			start: 3,
			end: 3
		},
		{
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [grouped.map(({ group, items }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: group }), items.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { children: items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("b", { children: item.name }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("small", { children: [
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: expenseLabels.suggestedReserve }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: [
								expenseLabels.emergencyReserveTitle,
								": NT$ ",
								money.format(emergencyReserve)
							] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "這筆金額用來模擬一次突發就醫時的現金緩衝，不代表能支付完整治療，也不是狗狗一生的醫療費。" })
						]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
...
function ProfileSupplementForm({ profile, petName, breed, species = "dog", onChange, onBack, onReset }) {
	const selectedTypeLabel = getSpeciesConfig(species).breeds.find((item) => item.id === breed)?.label ?? (species === "cat" ? "貓咪" : "柴犬");
	...
	const toggleActivitySpace = (value) => {
		const nextSpaces = selectedActivitySpaces.includes(value) ? selectedActivitySpaces.filter((item) => item !== value) : [...selectedActivitySpaces, value];
		onChange({
			...profile,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: [
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
									...
									className: `supplement-choice ${selected ? "selected" : ""}`,
									"aria-pressed": selected,
									onClick: () => toggleActivitySpace(value),
									children: [selected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectedDot, {}), value]
								}, value);
							})
						}),
						selectedActivitySpaces.includes("其他") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "支出包含" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "到家後必要支出" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: ["NT$ ", money.format(requiredAfterArrivalTotal)] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
										className: "care-a4-money-note",
										children: "（晶片與寵物登記、狂犬病疫苗、基礎疫苗與初期健康檢查）"
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "一次性準備費" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: ["NT$ ", money.format(oneTimePreparationTotal)] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "每月基本支出" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: [
										"NT$ ",
										money.format(monthlyBasicTotal),
										"／月"
									] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "臨時／醫療支出" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: ["NT$ ", money.format(temporaryMedicalTotal)] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "初始醫療應急金" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("b", { children: ["NT$ ", money.format(emergencyReserve)] })] })
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: "金額摘要" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", { children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "初始醫療應急金" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dd", { children: ["NT$ ", money.format(emergencyReserve)] })] }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "care-a4-money-total",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { children: "最低應準備金額" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dd", { children: ["NT$ ", money.format(suggestedPreparedTotal)] })]
									})
								] })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "care-a4-money-disclaimer",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function PetAcquisitionPage({ onBack, onReset }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "nav-buttons legal-acquisition-footer-actions",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					className: "secondary",
					type: "button",
					onClick: onBack,
					...
					className: "legal-final-actions",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "secondary",
						type: "button",
						onClick: shareWithOthers,
						children: ["分享給他人 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "↗" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						className: "primary",
						type: "button",
						onClick: onReset,
						children: ["重新體驗 ", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "↻" })]
					})]
				})]
			}),
			shareMessage && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "legal-share-status",
				role: "status",
					...
					children: [
						...
						step === 1 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SpeciesStep, {
							...
							onCategory: (nextCategory) => {
								...
								if (nextCategory === "cat" && petName === "小狗") setPetName("");
							},
							onBreed: (id) => {
								setBreed(id);
