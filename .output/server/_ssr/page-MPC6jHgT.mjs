...
//#region node_modules/.nitro/vite/services/ssr/assets/page-MPC6jHgT.js
...
function VideoScenarioActivity({ scenario, answer, petName, onChoose, onCorrectComplete }) {
	...
	const source = scenario.id === "arrival-adjustment" ? "/assets/pet-journey/first-day.mp4" : scenario.id === "growing-old" ? "/assets/pet-journey/time-passes-old.mp4" : "/assets/pet-journey/sick.mp4";
	const selectedChoice = scenario.choices.find((choice) => choice.id === answer?.finalChoiceId);
